...
event_col = ['label']  # Survival event column
time_col = ['value']  # Survival time column
...
for i in range(n_exp):
    ...
    surv_df.to_csv("./output/discharge_CoxCC.csv", index=True)
...
# D-Calibration
d_calib = d_calibration(df_test['label'], surv.iloc[6])
