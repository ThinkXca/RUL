...
for i in range(n_exp):
    df_train, df_val, df_test = train_val_test_stratified_split(d, 'label', frac_train=0.8, frac_val=0.05, frac_test=0.15, random_state=10)
    ...
    labels_train = np.array([(e, t) for e, t in zip(df_train['label'], df_train['value'])], dtype=[('label', 'bool'), ('value', 'float')])
    labels_test = np.array([(e, t) for e, t in zip(df_test['label'], df_test['value'])], dtype=[('label', 'bool'), ('value', 'float')])
