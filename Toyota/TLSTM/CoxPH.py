...
# CoxPH model
def CoxPH_():
    df_train, df_val, df_test = train_test_split_with_val(d, 'label', frac_train=0.8, frac_val=0.05, frac_test=0.15, random_state=10)
    ...
    surv_df.to_csv("./output/discharge_CoxPH.csv", index=True)
...
def view_results(num_experiments):
    ...
    # d-calibration 
    d_cal = d_calibration(df_test.label, surv.iloc[6])
    print('d-calibration: \n')
